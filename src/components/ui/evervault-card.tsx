...
export function CardPattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${fromColor} ${toColor} opacity-0 backdrop-blur-xl transition duration-500 group-hover/card:opacity-100`}
        style={style}
      />
